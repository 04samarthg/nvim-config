...
local TerminalName = {
    ...
    {
        provider = function()
            local id = require("toggleterm"):current_term_index()
            return " " .. (id or "Exited")
        end,
...
local separate = { provider = separators.rounded_right }
...
local TerminalStatusline = {
    condition = function()
        return conditions.buffer_matches({ buftype = { "#toggleterm" } })
    end,
    hl = { bg = "dark_red" },
